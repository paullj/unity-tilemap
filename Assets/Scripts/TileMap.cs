...
namespace toinfiniityandbeyond.Tilemapping
{
	...
	public class TileMap : MonoBehaviour
	{
		...
		public BaseTile primaryTile;
		public BaseTile secondaryTile;

		[SerializeField]
		private int width = 20, height = 20;
		[SerializeField]
		private BaseTile [] map = new BaseTile [0];
		...
		*/
		...
		public BaseTile GetTileAt (Vector2 worldPoint)
		{
			return GetTileAt (WorldPointToCoordinate(worldPoint));
		}
		public BaseTile GetTileAt (Coordinate coordinate)
		{
		...
		public bool SetTileAt (Vector2 worldPoint, BaseTile to)
		{
			return SetTileAt (WorldPointToCoordinate (worldPoint), to);
		}
		public bool SetTileAt (Coordinate coordinate, BaseTile to)
		{
			return SetTileAt (coordinate.x, coordinate.y, to);
		}
		public bool SetTileAt (int x, int y, BaseTile to)
		{
			BaseTile from = GetTileAt (x, y);
